...
| **Equipo** | 1. [100%] Jahir Castillo Paucas<br>2. [100%] Jostin Chavez Estela<br>3. [100%] Marilin Andrea Medina Apolinario<br>4. [100%] Eric Mozombite Shishco<br>5. [100%] María Ruiz Luna |
| **Ciclo** | 2026-II |
...
*   **Sostenibilidad y Ecoeficiencia Operativa (Modelo CAPEX Reutilizable):** La propuesta reduce el uso de estructuras y recuerdos desechables mediante activos reusables de larga vida útil y entregas digitales por códigos QR. Se plantea como un modelo de **reducción de merma**, sujeto a medición mediante residuos y consumibles por evento; no implica ausencia absoluta de residuos.
...
El proyecto demuestra viabilidad económica en el escenario realista, con **143 eventos**, ingresos por **S/. 199,742.50**, utilidad neta de **S/. 18,896.21**, EBITDA de **S/. 52,787.10**, VAN de **S/. 51,681.83** y TIR de **29.05%**, superior al COK de 14%. El punto de equilibrio es **9.47 eventos por mes**, por lo que se requieren 10 eventos para superarlo. La liquidez permanece positiva, aunque la caja mínima de S/. 31,400.13 queda S/. 9,999.87 por debajo de la reserva objetivo de S/. 41,400; la Fase 2 debe incorporar financiamiento complementario si se desea mantener dicha reserva totalmente intangible.
...
```mermaid
graph TD
    A[Evaluación COFACE] -->|Gestión de Riesgo Logístico| B(Importación Shenzhen-Callao)
    C[TAM-SAM-SOM] -->|Filtro INEI + APEIM 2025| D(SAM: 930 insatisfechos · SOM: 143 eventos)
    E[Modelo de Costeo Directo] -->|Validación de Fórmulas Financieras| F(Punto de Equilibrio: 9.47/mes)
    B & D & F --> G[Flujo de Caja Realista Año 1]
```
...
| :--- | :---: | :--- |
| **Ticket Promedio Ponderado** | S/. 1,396.80 | Promedio ponderado de los paquetes Individual (S/. 750), Dúo (S/. 1,300), Trío (S/. 1,800) y Full (S/. 2,300), considerando el mix por fase. |
| **Costo Variable Promedio** | S/. 298.98 | Incluye transporte tercerizado, internet móvil y consumibles por equipo. Los técnicos part-time se reconocen en la planilla fija, evitando duplicar su costo. |
| **Margen de Contribución Unitario** | S/. 1,097.82 | S/. 1,396.80 (Precio) - S/. 298.98 (Costo Variable). Representa el 78.59% de los ingresos por evento. |
...
| :--- | :---: | :--- |
| **Planilla MYPE Total** | S/. 7,083.45 (promedio mensual) | Incluye tres socios y técnicos part-time escalonados: 2 en Fase 1, 3 en Fase 2 y 4 en Fase 3. Los socios perciben bases de S/. 1,130, S/. 1,300 y S/. 1,500 según fase. |
...
| **Servicios y Mantenimiento** | S/. 800.00 | S/. 400 de servicios básicos y S/. 400 de mantenimiento, repuestos, almacenamiento en nube y software. |
...
| **Capital de Trabajo Neto** | S/. 78,172.67 | Incluye una reserva objetivo de S/. 41,400.00, equivalente a aproximadamente 5.8 meses de la planilla promedio, además de cobertura operativa y tributos recuperables. |
| **Inversión Inicial Total** | S/. 142,005.56 | Suma de Activos Tangibles (S/. 48,836.89), Activos Intangibles (S/. 14,996.00) y Capital de Trabajo (S/. 78,172.67). |
| **Inversión Total Modelada** | S/. 176,152.78 | Inversión inicial más CAPEX de expansión de Fase 2 por S/. 34,147.22. |
...
```mermaid
pie title Estructura de Requerimiento de Capital (T.C. S/. 3.386)
    "Activos Físicos / Tangibles (S/. 48,836.89)" : 48836.89
    "Activos Intangibles (S/. 14,996.00)" : 14996.00
    "Capital de Trabajo (S/. 78,172.67)" : 78172.67
```
...
*   **Político:** El Perú mantiene un marco comercial abierto y un TLC vigente con China. La preferencia arancelaria debe verificarse por cada subpartida, certificado de origen y cronograma de desgravación; no se asume automáticamente un Ad Valorem de 0% para todo el portafolio.
*   **Económico:** Las proyecciones utilizan inflación anual de **2.5%**, tipo de cambio de **S/. 3.386 por USD** y financiamiento bancario de S/. 40,000. COFACE se utiliza para riesgo país y clima de negocios, no como fuente del crecimiento sectorial; cualquier estimación de crecimiento del mercado de eventos debe sustentarse por separado.
...
*   **Ecológico (Ambiental):** El modelo reduce residuos mediante equipos reutilizables y entregas digitales. Persisten consumibles, embalajes, mantenimiento y residuos electrónicos, por lo que el desempeño ambiental debe medirse y gestionarse bajo RAEE.
...
| **Estructura de Precios** | Ticket alto por insumos físicos (S/. 1,500+) | Elevado, orientado a grandes marcas | Bajo, pero con tecnología obsoleta | **Ticket promedio B2B competitivo (S/. 1,396.80)** |
...
#### ⚡ Factores Externos
*   **Oportunidades (O):**
    1.  Creciente adopción de experiencias digitales en eventos premium; la tasa sectorial debe validarse con una fuente especializada antes de presentarla como dato de mercado.
...
*   **Estrategias FO (Maxi-Maxi):**
    *   **FO-01:** Utilizar el portafolio diversificado de 4 líneas y la meta OTIF del 96% para cerrar **contratos marco de exclusividad** con Wedding Planners premium, aprovechando la adopción creciente de experiencias digitales (F1, F2, O1, O3).
...
*   **Estrategias DA (Mini-Mini):**
    *   **DA-01:** Implementar y defender la **reserva objetivo de S/. 41,400** (aprox. 5.8 meses de planilla promedio) y cubrir la brecha de S/. 9,337.27 antes de ejecutar la Fase 2 si se desea mantenerla totalmente intangible (D2, A2).
...
*   **Restricción de Capital de Trabajo: Reserva Objetivo de S/. 41,400:** La empresa establece una reserva equivalente a aproximadamente 5.8 meses de la planilla promedio de socios y técnicos. Si se declara intangible, no debe emplearse para:
    ...
    *Nota: La caja mínima alcanza S/. 31,400.13 en marzo de 2027 después del CAPEX de Fase 2. Aunque permanece positiva, queda S/. 9,999.87 por debajo de la reserva objetivo. Para mantenerla totalmente intangible se debe negociar crédito de proveedor, leasing o un aporte complementario antes de ejecutar la expansión.*
...
*   **Fase 1: Importación inicial de 4 equipos (Mes 0):** Se importan cuatro equipos interactivos, uno de cada línea. La inversión inicial comprende activos tangibles por **S/. 48,836.89**, intangibles por **S/. 14,996.00** y capital de trabajo por **S/. 78,172.67**.
*   **Fase 2: Expansión a 8 equipos (Mes 5 - Marzo 2027):** Se incorporan cuatro equipos adicionales mediante un CAPEX de **S/. 34,147.22**. El modelo puede pagarlo con la caja disponible, pero no mantiene íntegra la reserva objetivo; para respetar esa restricción se requiere financiamiento complementario de aproximadamente S/. 10,000.
...
*   **Categoría A:** Equipos interactivos de las 4 líneas (plataforma 360°, espejo mágico, cabina LED y audio-guestbook) y routers Multi-Carrier de conectividad. *(La captura de imagen se realiza con smartphones propios del equipo; no se importan cámaras ni tablets.)*
...
```mermaid
flowchart LR
    subgraph F1 ["1. Fase Internacional (Importación)"]
        direction LR
        A["Shenzhen, China - Proveedor ISO 9001"] -->|Flete Marítimo 35-45 días| B["Puerto del Callao - Aduanas"]
    end
    
    subgraph F2 ["2. Fase Nacional (Distribución y SLA)"]
        direction LR
        C["Levante - Canal Verde"] -->|Transporte Terrestre| D["Almacén - Lima"] -->|Calibración y SLA| E["Eventos - Clientes B2B"]
    end
    
    B -->|Despacho Anticipado| C
```
...
Todo equipo pasa por una prueba de software y calibración física 4 horas antes de salir del almacén hacia el venue. Los operarios deben contar con un kit de contingencia clase A in-situ (fusibles, cargadores portátiles adicionales, smartphone de captura de repuesto y doble SIM multi-carrier).
...
| :--- | :---: | :---: | :--- |
| **Falla crítica de hardware en pleno evento** | Alto | Baja | Kit de repuestos Clase A in-situ + smartphone de captura de respaldo en la maleta de transporte. |
...
*   **Ingresos Brutos:** Con un ticket promedio ponderado de **S/. 1,396.80** por evento, los ingresos totales del ejercicio ascienden a **S/. 199,742.50**.
*   **Costos y Gastos:**
    *   *Costos Variables:* S/. 42,754.00 (S/. 298.98 por evento, correspondientes a transporte, conectividad y consumibles; la planilla técnica está incluida en gastos administrativos).
    *   *Gastos Administrativos Fijos:* S/. 94,601.40 anuales (S/. 7,883.45 (Promedio MYPE) mensuales que incluyen planilla MYPE escalonada, servicios por S/. 400 y mantenimientos/licencias por S/. 400. Se opera desde domicilio/base propia sin pagar alquiler comercial en la primera fase).
    *   *Gastos de Ventas:* S/. 9,600 anuales (S/. 800 mensuales para marketing digital B2B).
*   **Resultado Neto:** La utilidad neta antes de intereses e impuestos (EBITDA) es de **S/. 52,787.10**. Tras la provisión de impuestos bajo el Régimen MYPE Tributario (10% sobre la renta neta) y el servicio de la deuda, se alcanza una utilidad neta final de **S/. 18,896.21**.
*   **Flujo Acumulado:** El flujo de caja financiero cierra el primer año con un saldo acumulado positivo de **S/. 67,704.73**, después de cubrir el servicio de deuda anual de **S/. 21,408.25**. La caja mínima es **S/. 31,400.13** en marzo de 2027, inmediatamente después del CAPEX de Fase 2.
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| *Saldo Inic.* | - | - | - | - | - | - | - | - | - | - | 72,572.67 |
| **Nov 2026** | 8 | 9,820.00 | 2,288.00 | 6,498.35 | 800.00 | 1,715.94 | -1,482.29 | -174.96 | -1,784.02 | 0.00 | 70,847.33 |
| **Dic 2026** | 8 | 9,820.00 | 2,288.00 | 6,498.35 | 800.00 | 1,715.94 | -1,482.29 | -174.96 | -1,784.02 | 0.00 | 69,122.00 |
| **Ene 2027** | 7 | 8,592.50 | 2,002.00 | 6,498.35 | 800.00 | 1,715.94 | -2,423.79 | -174.96 | -1,784.02 | 0.00 | 66,455.16 |
| **Feb 2027** | 8 | 9,820.00 | 2,288.00 | 6,498.35 | 800.00 | 1,715.94 | -1,482.29 | -174.96 | -1,784.02 | 0.00 | 64,729.83 |
| **Mar 2027** | 11 | 14,657.50 | 3,234.00 | 7,847.00 | 800.00 | 1,715.94 | 1,060.56 | -174.96 | -1,784.02 | -34,147.22 | 31,400.13 |
| **Abr 2027** | 12 | 15,990.00 | 3,528.00 | 7,847.00 | 800.00 | 1,715.94 | 2,099.06 | -174.96 | -1,784.02 | 0.00 | 33,256.14 |
| **May 2027** | 15 | 19,987.50 | 4,410.00 | 7,847.00 | 800.00 | 1,715.94 | 5,214.56 | -174.96 | -1,784.02 | 0.00 | 38,227.65 |
| **Jun 2027** | 14 | 18,655.00 | 4,116.00 | 7,847.00 | 800.00 | 1,715.94 | 4,176.06 | -174.96 | -1,784.02 | 0.00 | 42,160.67 |
| **Jul 2027** | 16 | 24,640.00 | 4,960.00 | 9,305.00 | 800.00 | 1,715.94 | 7,859.06 | -174.96 | -1,784.02 | 0.00 | 49,776.68 |
| **Ago 2027** | 13 | 20,020.00 | 4,030.00 | 9,305.00 | 800.00 | 1,715.94 | 4,169.06 | -174.96 | -1,784.02 | 0.00 | 53,702.70 |
| **Sep 2027** | 15 | 23,100.00 | 4,650.00 | 9,305.00 | 800.00 | 1,715.94 | 6,629.06 | -174.96 | -1,784.02 | 0.00 | 60,088.71 |
| **Oct 2027** | 16 | 24,640.00 | 4,960.00 | 9,305.00 | 800.00 | 1,715.94 | 7,859.06 | -174.96 | -1,784.02 | 0.00 | 67,704.73 |
...
*   **Punto de Equilibrio Operativo:** Se sitúa en **9.47 eventos mensuales**; en términos enteros se requieren **10 eventos** para superarlo. Durante Fase 1 la capacidad máxima es 8, por lo que sus déficits mensuales están previstos y cubiertos por el capital de trabajo.
*   **Margen Neto:** **9.46%** (S/. 18,896.21 / S/. 199,742.50).
*   **Retorno sobre la Inversión (ROI):** **10.73%** sobre la inversión total modelada de S/. 176,152.78.
*   **Periodo de Recuperación (Payback):** La inversión inicial asciende a **S/. 142,005.56** (aporte de socios S/. 102,005.56 y préstamo S/. 40,000). Con los flujos libres proyectados, el payback descontado se alcanza aproximadamente a los **2.55 años**.
...
*   **Escenario Pesimista (130 eventos anuales):** Genera una utilidad neta de **S/. 6,051.70**. Es rentable, pero requiere vigilancia de caja y no demuestra por sí solo que la reserva objetivo permanezca intacta.
*   **Escenario Optimista (160 eventos anuales):** Representa la capacidad anual máxima del calendario por fases y genera una utilidad neta de **S/. 35,692.89**.
...
| :--- | :---: | :---: | :---: |
| **Eventos Anuales** | 130 eventos | 143 eventos | 160 eventos |
| **Ingresos Anuales** | S/. 181,584.09 | S/. 199,742.50 | S/. 223,488.11 |
| **(−) Costo Variable** | -S/. 38,867.27 | -S/. 42,754.00 | -S/. 47,836.64 |
| **(=) Margen de Contribución** | S/. 142,716.82 | S/. 156,988.50 | S/. 175,651.47 |
| **(−) Gastos Fijos + Deprec. + Intereses** | -S/. 135,992.71 | -S/. 135,992.71 | -S/. 135,992.71 |
| **(=) Utilidad Antes de Impuestos** | S/. 6,724.11 | S/. 20,995.79 | S/. 39,658.76 |
| **(−) Impuesto a la Renta MYPE (10%)** | -S/. 672.41 | -S/. 2,099.58 | -S/. 3,965.88 |
| **(=) Utilidad Neta del Ejercicio** | S/. 6,051.70 | S/. 18,896.21 | S/. 35,692.89 |
| **Evaluación de Viabilidad** | **Viable y Rentable** | **Viable y Rentable** | **Altamente Viable** |
...
*   **Regulación Aduanera (POL-GEN-01):** La condición de mercancía restringida, la preferencia arancelaria y cualquier homologación se verifican por subpartida y especificación técnica antes del embarque. El despacho anticipado reduce tiempos, pero no garantiza por sí solo canal verde ni levante automático.
...
2.  **Viabilidad Financiera:** Genera utilidad neta positiva en el Año 1 (S/. 18,896.21), con ROI de 10.73%, VAN de S/. 51,681.83 y TIR de 29.05%, superior al COK del 14%.
3.  **Viabilidad de Mercado:** Existe un mercado objetivo en los segmentos A/B de Lima que valora la inmediatez digital y la reducción de residuos mediante activos reutilizables.
...
1.  **Fase 1 (Mes 1-4, nov-feb):** Operar con los 4 equipos iniciales y controlar los déficits previstos, dado que la capacidad máxima de 8 eventos/mes es inferior al punto de equilibrio de 9.47.
2.  **Fase 2 (Mes 5, mar-2027):** Ejecutar el CAPEX de expansión de S/. 34,147.22 para duplicar el stock a 8 unidades. Si la reserva de S/. 41,400 debe permanecer intacta, contratar aproximadamente S/. 10,000 de financiamiento complementario.
...
2.  **Control del Costo Variable:** Asegurar que el costo variable por evento no supere el límite de **S/. 298.98** para proteger el margen bruto del 78.6%.
